      ...
      <Card>
        <CardBody className="grid gap-3 md:grid-cols-[1fr_auto]">
          <label className="relative">
            ...
            <input className="min-h-12 w-full rounded-lg border border-slate-200 pl-10 pr-3 text-sm shadow-sm focus:border-gold focus:ring-2 focus:ring-gold/20" placeholder="Search by client, campaign, or DAB reference" />
          </label>
